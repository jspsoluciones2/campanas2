...
\restrict 4Qo7b0bnhdaevsDY06AvbDY1fbLdaW87vxgMGOxv3fA0IDhcC1zLZVaKFX36twU
...
--
-- Name: asignar_codigo_serial(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.asignar_codigo_serial() RETURNS trigger
    LANGUAGE plpgsql
    AS $_$
DECLARE
...
ALTER FUNCTION public.asignar_codigo_serial() OWNER TO postgres;
...
CREATE FUNCTION public.ids_campanas_usuario() RETURNS SETOF uuid
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT id_campana
...
CREATE FUNCTION public.match_puestos_votacion(query_embedding public.vector, match_count integer DEFAULT NULL::integer, filter jsonb DEFAULT '{}'::jsonb) RETURNS TABLE(id uuid, content text, metadata jsonb, similarity double precision)
    LANGUAGE plpgsql
    AS $$
...
begin
  ...
  select
    pv.id,
    concat_ws(E'\n',
      'Puesto de votación: ' || pv.nombre,
      'Municipio: ' || coalesce(pv.municipio, 'N/D'),
      'Dirección: ' || coalesce(pv.direccion, 'N/D'),
      'Código: ' || pv.codigo::text,
      'Mesas: ' || pv.cantidad_mesas::text
    ) as content,
    jsonb_build_object(
      'id', pv.id,
      'nombre', pv.nombre,
      'municipio', pv.municipio,
...
CREATE FUNCTION public.match_votantes(query_embedding public.vector, match_count integer DEFAULT NULL::integer, filter jsonb DEFAULT '{}'::jsonb) RETURNS TABLE(id uuid, content text, metadata jsonb, similarity double precision)
    LANGUAGE plpgsql
    AS $$
#variable_conflict use_column
begin
  ...
  select
    ...
    concat_ws(E'\n',
      ...
      'Documento: ' || coalesce(v.tipo_documento::text, '') || ' ' || coalesce(v.documento, 'N/D'),
      'Rol: ' || coalesce(r.nombre, 'Sin rol asignado (probablemente votante)'),
      'Teléfono: ' || coalesce(v.telefono, 'N/D'),
      'Puesto de votación: ' || coalesce(pv.nombre, 'N/D')
    ) as content,
    jsonb_build_object(
      'id', v.id,
      'nombres', v.nombres,
  ...
  left join public.puestos_votacion pv on pv.id = v.id_puesto_votacion
  left join public.roles r on r.id = v.id_rol
  where v.embedding is not null
    and to_jsonb(v) @> filter
...
--
-- Name: puede_administrar_campana(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.puede_administrar_campana(p_id_campana uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
...
ALTER FUNCTION public.puede_administrar_campana(p_id_campana uuid) OWNER TO postgres;

--
-- Name: puede_editar_campana(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.puede_editar_campana(p_id_campana uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT es_dueno_plataforma()
...
ALTER FUNCTION public.puede_editar_campana(p_id_campana uuid) OWNER TO postgres;

--
-- Name: puede_leer_campana(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.puede_leer_campana(p_id_campana uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT es_dueno_plataforma()
...
ALTER FUNCTION public.puede_leer_campana(p_id_campana uuid) OWNER TO postgres;

--
-- Name: subarbol_votantes(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.subarbol_votantes(id_votante_raiz uuid) RETURNS TABLE(id_votante uuid, profundidad integer)
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
...
ALTER FUNCTION public.subarbol_votantes(id_votante_raiz uuid) OWNER TO postgres;
...
--
-- Name: COLUMN barrios.codigo; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.barrios.codigo IS 'ID autoincremental por comuna.';
...
CREATE TABLE public.campanas (
    ...
    id_proceso_electoral uuid NOT NULL,
    nombre text NOT NULL,
...
--
-- Name: COLUMN campanas.codigo; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.campanas.codigo IS 'ID autoincremental global de la plataforma.';
...
--
-- Name: COLUMN clientes.codigo; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.clientes.codigo IS 'ID autoincremental global de la plataforma.';
...
--
-- Name: COLUMN comunas.codigo; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.comunas.codigo IS 'ID autoincremental por campaña.';
...
CREATE TABLE public.configuracion_integracion_plataforma (
    ...
    creado_en timestamp with time zone DEFAULT now() NOT NULL,
    actualizado_en timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT configuracion_integracion_plataforma_proveedor_check CHECK ((proveedor = ANY (ARRAY['resolutor_captcha'::public.proveedor_integracion, 'ia_e14'::public.proveedor_integracion])))
);
...
CREATE TABLE public.cuarentena_votantes (
    ...
    telefono text,
    direccion text,
    id_puesto_votacion uuid,
    mesa text,
    id_rol uuid,
    id_lider_directo uuid,
    id_votante_conflicto uuid,
    id_cuarentena_conflicto uuid,
...
--
-- Name: COLUMN lugares_trabajo.codigo; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.lugares_trabajo.codigo IS 'ID autoincremental por campaña.';
...
--
-- Name: COLUMN procesos_electorales.codigo; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.procesos_electorales.codigo IS 'ID autoincremental global de la plataforma.';
...
--
-- Name: COLUMN puestos_votacion.codigo; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.puestos_votacion.codigo IS 'ID autoincremental por campaña.';
...
--
-- Name: COLUMN roles.codigo; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.roles.codigo IS 'ID autoincremental por campaña.';
...
COMMENT ON TABLE public.sesiones_captura_whatsapp IS 'Estado conversacional del bot WhatsApp por número de teléfono.';
...
--
-- Name: COLUMN tipos_novedad.codigo; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.tipos_novedad.codigo IS 'ID autoincremental por campaña.';
...
00000000-0000-0000-0000-000000000000	35	7xnyyc2p7rom	1a9105d7-e0d8-4d02-9a88-b34ec796f1c7	f	2026-07-11 21:27:24.486818+00	2026-07-11 21:27:24.486818+00	xjzkkiiu4ldn	18e51522-c726-494d-84ce-4036e41fdb0e
\.
...
18e51522-c726-494d-84ce-4036e41fdb0e	1a9105d7-e0d8-4d02-9a88-b34ec796f1c7	2026-06-15 16:15:01.372117+00	2026-07-11 21:27:24.501204+00	\N	aal1	\N	2026-07-11 21:27:24.50107	node	190.60.32.85	\N	\N	\N	\N	\N
...
COPY public.barrios (id, id_comuna, nombre, creado_en, codigo) FROM stdin;
6133e19d-d62a-479c-965f-580a727d6e43	55470fad-2694-4f7c-b46a-61c3568074a0	Paramo	2026-06-15 16:52:50.011994+00	1
aa1a3c80-421b-4590-b02e-66bf8d981e94	83497270-b990-4d2b-9ba8-49cfc8c5ee56	ANIVERSARIO	2026-07-06 22:20:28.264707+00	1
4eb12387-33a3-4a77-b0dc-762904944cab	55470fad-2694-4f7c-b46a-61c3568074a0	CENTRO	2026-07-06 22:21:33.966114+00	2
a0bdf55e-d835-455f-9782-064ab556d34a	1c04a8e4-632b-4a02-942e-14a025a2ec49	GUIAMARAL	2026-07-06 22:22:08.165422+00	1
c9195afe-4922-4d16-8c80-0255dc8cedcb	55470fad-2694-4f7c-b46a-61c3568074a0	El Contento	2026-07-09 01:01:16.270263+00	3
5b9bd286-99a0-42ec-9793-ce8d595cb47a	4d048635-d3c6-41b8-90c2-664d65ffd778	Comuna 8 Oriental	2026-07-09 00:56:18.733269+00	8
c17c073c-9b9b-4f89-96ec-3c70ef8a33d1	4d048635-d3c6-41b8-90c2-664d65ffd778	Comuna 9 Nororiental	2026-07-09 00:56:18.733269+00	9
42bcbf01-aa9f-48c9-88eb-e26b458a590c	4d048635-d3c6-41b8-90c2-664d65ffd778	Comuna 10 Sur	2026-07-09 00:56:18.733269+00	10
\.
...
COPY public.datos_trabajador_votante (id, id_votante, lugar_trabajo, direccion_trabajo, id_comuna, id_barrio, creado_en, actualizado_en) FROM stdin;
\.
...
COPY public.exportaciones_campana (id, id_campana, exportado_por, ruta_almacenamiento, tamano_archivo, creado_en) FROM stdin;
\.
...
COPY public.integraciones_campana (id, id_campana, proveedor, configuracion_cifrada, activa, creado_en, actualizado_en) FROM stdin;
b819ac21-daee-424a-af61-4759468f22d5	4d048635-d3c6-41b8-90c2-664d65ffd778	telegram	{"bot_token":"8656422602:AAGMyVBYaSI6fFKy5cIwIZRoY25m9yAveDs","codigo_vinculacion":"WMRTZLBM","webhook_secret":"98b83c8bf1e74064af68d438a073d2ec","bot_username":"CampanasPoliticasBot","webhook_registrado_en":"2026-06-15T21:41:02.211Z"}	t	2026-06-15 21:41:00.771814+00	2026-06-15 21:41:01.469938+00
\.
...
COPY public.lugares_trabajo (id, id_campana, nombre, direccion, id_comuna, id_barrio, creado_en, actualizado_en, codigo) FROM stdin;
cdd3185b-5475-48b5-9b6e-5b7afd8ab656	4d048635-d3c6-41b8-90c2-664d65ffd778	Clinica Leones	Paramo	55470fad-2694-4f7c-b46a-61c3568074a0	\N	2026-06-15 17:34:38.766339+00	2026-06-15 17:35:18.040624+00	1
\.
...
COPY public.miembros_campana (id, id_campana, id_usuario, rol, creado_en) FROM stdin;
5893870c-14aa-4d77-bc1c-d0749b4e4712	4d048635-d3c6-41b8-90c2-664d65ffd778	dfb79c19-84a3-4ddc-890d-854173a7e13e	administrador_campana	2026-06-15 01:10:14.645093+00
\.
...
COPY public.miembros_cliente (id, id_cliente, id_usuario, creado_en) FROM stdin;
2189dc11-40f5-4d2d-be40-56283679a1f3	40bbd14d-bea0-44aa-9ff0-516f0fd5d5f5	dfb79c19-84a3-4ddc-890d-854173a7e13e	2026-06-15 00:58:01.303384+00
\.
...
COPY public.novedades (id, id_votante, id_tipo_novedad, detalle, creado_por, creado_en) FROM stdin;
\.
...
COPY public.procesos_electorales (id, nombre, fecha_eleccion, creado_en, codigo) FROM stdin;
1280f1bf-0e8c-41fd-8be5-9394936ec43b	Alcaldia 2028	2028-11-14	2026-06-14 23:44:13.535536+00	1
60447c5c-484d-4c6f-8744-c37d5e72ad8d	Presidencia 2026	2026-06-21	2026-06-15 01:23:26.30312+00	2
\.
...
COPY public.puestos_votacion (id, id_campana, id_comuna, id_barrio, nombre, municipio, direccion, votantes_hombres_admite, votantes_mujeres_admite, cantidad_mesas, fuente, actualizado_registraduria_en, creado_en, actualizado_en, codigo, embedding) FROM stdin;
935e01ce-bd7d-4844-b18b-8ddcd4862ae7	4d048635-d3c6-41b8-90c2-664d65ffd778	937e5eb8-e8a7-4abd-80b1-9d888d9bc53a
\.
...
COPY public.recolectores_telegram (id, id_campana, id_usuario, telegram_user_id, telegram_username, creado_en, id_rol) FROM stdin;
6d115864-8347-4158-a301-4f00b9ff3c34	4d048635-d3c6-41b8-90c2-664d65ffd778	\N	912650646	AnaMaria1993	2026-06-15 22:13:18.982232+00	9c23fe0c-cfb6-432e-bf61-7880c40efc12
\.
...
COPY public.registro_auditoria (id, id_actor, accion, tipo_entidad, id_entidad, id_campana, metadatos, creado_en) FROM stdin;
\.
...
COPY public.roles (id, id_campana, nombre, nivel_jerarquia, creado_en, codigo) FROM stdin;
9c23fe0c-cfb6-432e-bf61-7880c40efc12	4d048635-d3c6-41b8-90c2-664d65ffd778	Enlace	1	2026-06-15 17:33:07.752224+00	1
d80adb39-b05e-48e2-821d-d2722df281cf	4d048635-d3c6-41b8-90c2-664d65ffd778	Coordinador	2	2026-06-15 22:14:45.156758+00	2
b00018ea-6c0a-474e-b04f-4f3ce595edab	4d048635-d3c6-41b8-90c2-664d65ffd778	Lider	3	2026-06-16 00:46:19.946428+00	3
b507f0c8-5072-45b0-afac-33d63286c35c	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante	4	2026-06-16 00:55:38.504778+00	4
\.
...
COPY public.sesiones_captura_telegram (id, id_campana, chat_id, telegram_user_id, id_usuario, paso, datos_parciales, creado_en, actualizado_en) FROM stdin;
40d12155-679c-486a-9bf9-9f29e2ff6c09	4d048635-d3c6-41b8-90c2-664d65ffd778	1	1	\N	recolector_rol	{}	2026-06-15 22:10:53.97371+00	2026-06-15 22:10:53.97371+00
\.
...
COPY public.sesiones_captura_whatsapp (id, id_campana, telefono, perfil_nombre, id_usuario, paso, datos_parciales, creado_en, actualizado_en) FROM stdin;
676b8e5a-8484-4bc5-835d-e81a47362762	4d048635-d3c6-41b8-90c2-664d65ffd778	573001234567	\N	\N	inicio	{}	2026-06-19 02:08:52.497292+00	2026-06-19 02:08:52.497292+00
6e8789eb-9112-496c-a851-f71aa9d4ae6d	4d048635-d3c6-41b8-90c2-664d65ffd778	573005424395	Ana María	\N	inicio	{}	2026-06-19 02:23:10.500289+00	2026-06-21 21:19:46.587361+00
\.
...
COPY public.tipos_novedad (id, id_campana, novedad, creado_en, codigo) FROM stdin;
ec9bcbc7-c949-4fcc-8050-9addafe1a61e	4d048635-d3c6-41b8-90c2-664d65ffd778	El Documento Es De Otra Persona	2026-06-15 17:34:01.948453+00	1
\.
...
COPY public.uso_campana (id, id_campana, proveedor, metrica, cantidad, periodo_inicio, periodo_fin, registrado_en) FROM stdin;
\.
...
COPY public.verificaciones_registraduria (id, id_campana, documento, tipo_documento, estado, nombres_oficial, apellidos_oficial, departamento, municipio, puesto_votacion, mesa, mensaje_error, datos_crudos, id_corrida, intentos, consultado_en, creado_en, actualizado_en) FROM stdin;
\.
...
COPY public.votantes (id, id_campana, nombres, apellidos, documento, tipo_documento, sexo, fecha_nacimiento, telefono, direccion, id_puesto_votacion, mesa, id_rol, id_lider_directo, estado, canal_origen, creado_por, creado_en, actualizado_en, id_lugar_trabajo, id_tipo_novedad, detalle_novedad, embedding) FROM stdin;
ad640e58-4b57-4017-ad10-c2c76503ac0a	4d048635-d3c6-41b8-90c2-664d65ffd778	Andrea	Garcia	1093739659	CC	Femenino	1987-02-19	+573112167406	Av 4AN #0A-70	\N	\N	\N	\N	pendiente_verificacion	whatsapp	\N	2026-07-10 23:19:40.711593+00	2026-07-10 23:22:41.276158+00	\N	\N	\N	\N
c615cf24-dab3-4c38-a21a-e071c449883b	4d048635-d3c6-41b8-90c2-664d65ffd778	Luis Miguel Ángel	Ortiz	1090510187	CC	Masculino	1997-10-03	+573219131247	Av 5a # 7-77 prados del este	\N	\N	\N	\N	pendiente_verificacion	whatsapp	\N	2026-07-10 23:19:40.71171+00	2026-07-10 23:24:20.294416+00	\N	\N	\N	\N
2aeacdb4-6130-4383-877a-d91bd5ec59fe	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 7	Prueba	109000007	CC	Masculino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:05:46.100709+00	\N	\N	\N	\N
236e913c-6ca8-496a-8d48-4ec9e8e0869f	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 9	Prueba	109000009	CC	Femenino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:05:50.555168+00	\N	\N	\N	\N
78e421d0-8974-4b7b-a6da-44e1d0e8a143	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 8	Prueba	109000008	CC	Masculino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:06:00.694716+00	\N	\N	\N	\N
a70251a9-45bf-49c1-a084-e29a4a33639b	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 1	Prueba	109000001	CC	Femenino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:06:08.090472+00	\N	\N	\N	\N
a9c86f92-4160-4262-941e-62f7b75f33b0	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 3	Prueba	109000003	CC	Masculino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:06:11.856589+00	\N	\N	\N	\N
b79effe9-9384-4825-989f-5b7f3c2d76fa	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 5	Prueba	109000005	CC	Femenino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:06:17.717178+00	\N	\N	\N	\N
bb05c850-7b7d-48fd-9715-035a7c4d5335	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 2	Prueba	109000002	CC	Masculino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:06:22.674811+00	\N	\N	\N	\N
c63e2d30-9763-4b9d-aa12-290fe10131fb	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 10	Prueba	109000010	CC	Femenino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:06:27.582519+00	\N	\N	\N	\N
f7544368-9ada-4936-bb16-98dc66629c51	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 6	Prueba	109000006	CC	Femenino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:06:37.122675+00	\N	\N	\N	\N
d506eef4-60e1-4ff5-8b25-afb900bcb873	4d048635-d3c6-41b8-90c2-664d65ffd778	Votante 4	Prueba	109000004	CC	Masculino	\N	\N	\N	\N	\N	\N	\N	pendiente_verificacion	manual	\N	2026-07-10 23:04:02.445015+00	2026-07-10 23:07:47.067303+00	\N	ec9bcbc7-c949-4fcc-8050-9addafe1a61e	el documento es de anamaria	\N
6d37542a-504b-4372-95e5-5fe4e661635b	4d048635-d3c6-41b8-90c2-664d65ffd778	juan sebastian 	pineda pabon	1090765432	CC	Masculino	1992-08-23	+573132596578	av 7 #4 -43 guaimaral	1a10f783-8c1d-41a7-a8dd-cc53e9f011d4	\N	b00018ea-6c0a-474e-b04f-4f3ce595edab	\N	activo	whatsapp	\N	2026-07-10 22:54:33.672463+00	2026-07-10 23:20:11.238638+00	\N	\N	\N	\N
\.
...
--
-- Name: barrios_comuna_codigo_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX barrios_comuna_codigo_unique ON public.barrios USING btree (id_comuna, codigo);
...
--
-- Name: campanas_codigo_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX campanas_codigo_unique ON public.campanas USING btree (codigo);
...
--
-- Name: clientes_codigo_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX clientes_codigo_unique ON public.clientes USING btree (codigo);
...
--
-- Name: comunas_campana_codigo_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX comunas_campana_codigo_unique ON public.comunas USING btree (id_campana, codigo);
...
--
-- Name: lugares_trabajo_campana_codigo_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX lugares_trabajo_campana_codigo_unique ON public.lugares_trabajo USING btree (id_campana, codigo);
...
--
-- Name: procesos_electorales_codigo_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX procesos_electorales_codigo_unique ON public.procesos_electorales USING btree (codigo);


--
-- Name: puestos_campana_codigo_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX puestos_campana_codigo_unique ON public.puestos_votacion USING btree (id_campana, codigo);
...
--
-- Name: roles_campana_codigo_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX roles_campana_codigo_unique ON public.roles USING btree (id_campana, codigo);
...
--
-- Name: tipos_novedad_campana_codigo_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX tipos_novedad_campana_codigo_unique ON public.tipos_novedad USING btree (id_campana, codigo);
...
--
-- Name: barrios barrios_asignar_codigo; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER barrios_asignar_codigo BEFORE INSERT ON public.barrios FOR EACH ROW EXECUTE FUNCTION public.asignar_codigo_serial('id_comuna');
...
--
-- Name: campanas campanas_asignar_codigo; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER campanas_asignar_codigo BEFORE INSERT ON public.campanas FOR EACH ROW EXECUTE FUNCTION public.asignar_codigo_serial('');
...
--
-- Name: clientes clientes_asignar_codigo; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER clientes_asignar_codigo BEFORE INSERT ON public.clientes FOR EACH ROW EXECUTE FUNCTION public.asignar_codigo_serial('');


--
-- Name: comunas comunas_asignar_codigo; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER comunas_asignar_codigo BEFORE INSERT ON public.comunas FOR EACH ROW EXECUTE FUNCTION public.asignar_codigo_serial('id_campana');
...
--
-- Name: lugares_trabajo lugares_trabajo_asignar_codigo; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER lugares_trabajo_asignar_codigo BEFORE INSERT ON public.lugares_trabajo FOR EACH ROW EXECUTE FUNCTION public.asignar_codigo_serial('id_campana');


--
-- Name: procesos_electorales procesos_electorales_asignar_codigo; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER procesos_electorales_asignar_codigo BEFORE INSERT ON public.procesos_electorales FOR EACH ROW EXECUTE FUNCTION public.asignar_codigo_serial('');


--
-- Name: puestos_votacion puestos_asignar_codigo; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER puestos_asignar_codigo BEFORE INSERT ON public.puestos_votacion FOR EACH ROW EXECUTE FUNCTION public.asignar_codigo_serial('id_campana');
...
--
-- Name: roles roles_asignar_codigo; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER roles_asignar_codigo BEFORE INSERT ON public.roles FOR EACH ROW EXECUTE FUNCTION public.asignar_codigo_serial('id_campana');
...
--
-- Name: tipos_novedad tipos_novedad_asignar_codigo; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER tipos_novedad_asignar_codigo BEFORE INSERT ON public.tipos_novedad FOR EACH ROW EXECUTE FUNCTION public.asignar_codigo_serial('id_campana');
...
--
-- Name: FUNCTION asignar_codigo_serial(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.asignar_codigo_serial() TO anon;
GRANT ALL ON FUNCTION public.asignar_codigo_serial() TO authenticated;
GRANT ALL ON FUNCTION public.asignar_codigo_serial() TO service_role;
...
--
-- Name: FUNCTION puede_administrar_campana(p_id_campana uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.puede_administrar_campana(p_id_campana uuid) TO anon;
GRANT ALL ON FUNCTION public.puede_administrar_campana(p_id_campana uuid) TO authenticated;
GRANT ALL ON FUNCTION public.puede_administrar_campana(p_id_campana uuid) TO service_role;


--
-- Name: FUNCTION puede_editar_campana(p_id_campana uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.puede_editar_campana(p_id_campana uuid) TO anon;
GRANT ALL ON FUNCTION public.puede_editar_campana(p_id_campana uuid) TO authenticated;
GRANT ALL ON FUNCTION public.puede_editar_campana(p_id_campana uuid) TO service_role;


--
-- Name: FUNCTION puede_leer_campana(p_id_campana uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.puede_leer_campana(p_id_campana uuid) TO anon;
GRANT ALL ON FUNCTION public.puede_leer_campana(p_id_campana uuid) TO authenticated;
GRANT ALL ON FUNCTION public.puede_leer_campana(p_id_campana uuid) TO service_role;
...
--
-- Name: FUNCTION subarbol_votantes(id_votante_raiz uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.subarbol_votantes(id_votante_raiz uuid) TO anon;
GRANT ALL ON FUNCTION public.subarbol_votantes(id_votante_raiz uuid) TO authenticated;
GRANT ALL ON FUNCTION public.subarbol_votantes(id_votante_raiz uuid) TO service_role;
...
\unrestrict 4Qo7b0bnhdaevsDY06AvbDY1fbLdaW87vxgMGOxv3fA0IDhcC1zLZVaKFX36twU
