...
import {
  deleteBarrioMaestraAction,
  updateBarrioMaestraAction,
...
export function BarrioMaestraRowActions({
  ...
  const handleDelete = () => {
    ...
    startTransition(async () => {
      const result = await deleteBarrioMaestraAction(barrio.id);
      if (result?.error) {
          ...
          >
            ...
            >
              ...
              >
                ...
                <h3
                  id={`edit-barrio-${barrio.id}`}
                  className="text-base font-semibold text-neutral-900"
                >
                  Editar barrio
                </h3>
                <p className="mt-1 text-sm text-neutral-500">{barrio.nombre}</p>
